...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#4f4600] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#5d4e00]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(51, 42, 0,0.58),rgba(73, 53, 0,0.22)_43%,rgba(53, 45, 0,0.34)),linear-gradient(0deg,rgba(27, 24, 0,0.18),rgba(27, 24, 0,0.08))]" />
