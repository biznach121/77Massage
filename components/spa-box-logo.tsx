...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783488909/stage4/spa_77massagetreat/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="77 Massage Treat - Wellness delivered, luxury defined">
        <Image
          src={src}
          alt="77 Massage Treat - Wellness delivered, luxury defined"
          fill
