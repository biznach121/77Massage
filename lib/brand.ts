...
export const brand: Brand = {
  ...
  shortName: "77 Massage",
  microTag: "WELLNESS DELIVERED, LUXURY DEFINED",
  description:
    "77 Massage Treat is a Accra massage studio built around one promise: you leave lighter than you came.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0543809863",
    phoneTel: "+233543809863",
    textPhone: "0543809863",
    textPhoneTel: "+233543809863",
    email: "hello@77massage.test",
    privacyEmail: "privacy@77massage.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@77massage_treat", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "we bring the spa\nto your door.\nWellness delivered, luxury defined.",
    subtitle:
      "Massage and body therapy in Accra — book a session and let the week go",
  ...
  editorial: {
    ...
    notes: [
      {
        body: "Life in Accra rarely leaves room to breathe. The hustle rewards pushing through — and quietly collects the bill from your skin, your back and your sleep.",
        className: "left-[5%] top-[25%] max-w-[330px]",
      },
      {
        body: "That is the gap 77 Massage Treat was built for: honest treatments, fair prices, and a space that treats your time with respect.",
        className: "right-[4%] top-[50%] max-w-[360px]",
      },
      {
        body: "Every session starts gently and ends with you lighter than you came. That is the whole point.",
    ...
    images: [
      {
        ...
        alt: "77 Massage Treat beauty treatment detail",
      ...
      },
      {
        ...
        alt: "77 Massage Treat self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "77 Massage Treat beauty ritual",
      ...
      },
      {
        ...
        alt: "77 Massage Treat calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "77 Massage Treat relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "77 Massage Treat beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "77 Massage Treat lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "77 Massage Treat mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "77 Massage Treat makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "77 Massage Treat foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@77massage_treat",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783488917/stage4/spa_77massagetreat/tiktok_0.mp4",
        alt: "77 Massage Treat treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783488921/stage4/spa_77massagetreat/tiktok_1.mp4",
        alt: "77 Massage Treat treatment video",
        position: "center",
      },
      {
      ...
      },
      {
        ...
        alt: "77 Massage Treat studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About 77 Massage Treat",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "77 Massage Treat is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0543809863 and text 0543809863 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0543809863, text 0543809863, or message @77massage_treat on Instagram." },
          ...
          { q: "Where are you located?", a: "77 Massage Treat is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@77massage.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "77 Massage Treat (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@77massage.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "77 Massage Treat is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@77massage.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to 77 Massage Treat",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0543809863", href: "tel:+233543809863" },
      { label: "Text", value: "0543809863", href: "sms:+233543809863" },
      { label: "Instagram", value: "@77massage_treat", href: "https://www.tiktok.com/@77massage_treat" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783488910/stage4/spa_77massagetreat/avatar.jpg",
    blurb:
      "77 Massage Treat in Accra — wellness delivered, luxury defined.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@77massage_treat" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0543809863", href: "tel:+233543809863" },
          { label: "Text 0543809863", href: "sms:+233543809863" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "77 Massage Treat — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
